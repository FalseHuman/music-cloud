...
from src.base.services import get_upload_avatar, validate_size_image
...
class AuthUser(models.Model):
    ...
    avatar = models.ImageField(upload_to=get_upload_avatar, blank=True, null=True, validators=[
                               FileExtensionValidator(allowed_extensions=['jpg']), validate_size_image])

    @property
    def is_authenticated(self):
        """Всегда возвращает True. Узнаем был ли пользователь аутентифицирован:)"""
        return True
